    ...
    <div className='app_banner_guide-container'>
        ...
        <div className='app_banner_guide-post' >
          <div className='app_banner_guide-post-content'>
            <a href={'#'} className="app_banner_guide-post-title" >{"i18n.language === 'en' ? posts[0].node.title : posts[0].node.localizations[0].title"}</a>
          ...
          <div className='hr' />
          <div  className='app_banner_guide-post-content'>
          <a href={'#'} className="app_banner_guide-post-title" >{"i18n.language === 'en' ? posts[1].node.title : posts[1].node.localizations[0].title"}</a>
