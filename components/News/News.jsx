...
import liberty from '../../assets/statue-of-liberty.png'
...
const News = ({posts, reviews}) => {
  ...
  return ( 
      ...
      <div className='app_news-container'>
                  ...
                  <div className='app_news-posts-container'>
                        <div className='app_news-posts' >
                              ...
                              <div className='app_news-posts-content'>
                                    ...
                                    <Link to={'/'} className='app_news-posts-content-link'>{t("read-more")} </Link>
                              </div>
                        </div>
                        <div className='app_news-posts'>
            ...
            <img className='app_news-statue' src={liberty} alt="statue of liberty"  />
      </div>
    </>
  )
}
